...
def Train(organ,numEpochs,lr, processData=False, loadModel=False):
    ...
    if processData == True:
        ...
        DicomParsing.GetTrainingData(patientsPath, organ)
    ...
    for epoch in range(numEpochs):
        ...
        #going to load 6 random patients at a time and shuffle images foor training. 
        d = 0
        while d < len(filesRange):
            ...
            for sliceNum in slices:
                ...
                loss = UNetModel.trainingStep(x,y)
        ...
        epochLoss = Validate(organ, UNetModel)
